    ...
    return (
        <div className='status-container'>
            <div className='status'>
                <p className='status-title'>Check your Status:</p>
                <div className='flex items-center justify-center'>
                    <p className='status-text'>Suggestion/Complaint ID:</p>
            ...
            {Complaints && Complaints.title && (
                <div className="status-render-container md:w-[600px]">
                    <p className='status-render-title'> Details:</p>
                    <p className='status-render-text'> Id: {(Complaints.id).toString()}</p>
                    <p className='status-render-text'>Suggestion/Complaint by: {(Complaints.complaintRegisteredBy).toString()}</p>
                    <p className='status-render-text'>Title: {Complaints.title}</p>
