    ...
    return (
        <div className='getter-container md:p-[30px]  md:m-5 xl:flex xl:flex-row'>
            <div className='getter-card md:m-5'>
                ...
                <div className='md:flex items-center'>
                    <p className='text-2xl font-semibold'>Remark: </p>
                ...
                <div className='flex'>
                    <button className="button-common hover:bg-blue-900" onClick={handleApproveComplaint}>Approve</button>
                    <button className="button-common hover:bg-blue-900" onClick={handleDeclineComplaint}>Decline</button>
                </div>
            ...
            <div className='getter-card md:m-5'>
                ...
                <div className='md:flex items-center'>
                    <p className='text-2xl p-3 font-semibold'> Id: </p>
                ...
                <button className="button-common hover:bg-blue-900" onClick={handleResolveComplaint}>Resolve</button>
            </div>
